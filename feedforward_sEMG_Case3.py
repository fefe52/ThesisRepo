...
def main():
    ...
    # Create the model
    model = Sequential()
    model.add(Dense(30,kernel_regularizer=regularizers.l2(0.001),  activation='relu',input_dim=n_input))
    #model.add(Dropout(.2))
    ...
    def plot_history(history):
        ...
        plt.title('MAE using MLP on sEMG data - study case 3')
        ...
        plt.title('MSE using MLP on sEMG data - study case 3')
        ...
        plt.title('MLP predictions on sEMG training - study case 3')
        ...
        plt.title('MLP predictions on sEMG test - study case 3')
